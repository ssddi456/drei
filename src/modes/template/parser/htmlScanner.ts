    ...
    function internalScan(): TokenType {
        ...
        switch (state) {
            ...
            case ScannerState.WithinContent:
                ...
                if (stream.advanceIfChars([_LCR, _EQS])) {
            ...
            case ScannerState.WithinTwoWayBindInterpolation:
                if (stream.advanceIfChars([_EQS, _RCR])) {
                    state = ScannerState.WithinContent;
                    return finishToken(offset, TokenType.EndInterpolation);
                }
                stream.advanceUntilChars([_EQS, _RCR]);
                return finishToken(offset, TokenType.InterpolationContent);
