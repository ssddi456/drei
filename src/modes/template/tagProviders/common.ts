...
export interface AttributeCollector {
    (attribute: string, type?: string, documentation?: string, alias?: string): void;
}
...
export function collectAttributesDefault(
    ...
    globalAttributes.forEach(attr => {
        collector(attr.label, attr.type, attr.documentation, attr.alias);
    });
}
...
export function genAttribute(label: string, type?: string, documentation?: string, alias?: string): Attribute {
    return { label, type, documentation, alias };
}
